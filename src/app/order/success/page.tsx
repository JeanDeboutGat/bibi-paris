    ...
    return (
        <div className="container-luxury min-h-[70vh] flex items-center justify-center">
            <div className="max-w-2xl mx-auto text-center">
                ...
                <h1 className="font-serif text-3xl md:text-4xl mb-6">Thank You for Your Order</h1>
                ...
                <p className="text-luxury-charcoal/70 mb-12">
                    We&apos;ll notify you once your order has been shipped. You can track your order status 
                    at any time by visiting the <Link href="/track" className="text-luxury-sienna hover:underline">order tracking page</Link>.
                </p>
