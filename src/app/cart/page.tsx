                ...
                <div className="lg:col-span-2">
                    <div className="border-b border-luxury-gold/10 pb-2 hidden md:grid grid-cols-12 gap-4">
                        <div className="col-span-6">
                            <span className="text-sm uppercase tracking-wider text-luxury-charcoal/60">Product</span>
                        </div>
                        <div className="col-span-2 text-center">
                            <span className="text-sm uppercase tracking-wider text-luxury-charcoal/60">Quantity</span>
                        </div>
                        <div className="col-span-2 text-right">
                            <span className="text-sm uppercase tracking-wider text-luxury-charcoal/60">Price</span>
                        </div>
                        <div className="col-span-2 text-right">
                            <span className="text-sm uppercase tracking-wider text-luxury-charcoal/60">Total</span>
                        </div>
                    </div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-center">
                                ...
                                <div className="col-span-6 flex gap-4">
                                    ...
                                    <div className="flex flex-col justify-center">
                                        ...
                                        <div className="flex items-center mt-2 md:hidden">
                                            <span className="text-sm text-luxury-charcoal/60 w-20">Price:</span>
                                ...
                                <div className="col-span-2 flex md:justify-center">
                                    <div className="flex items-center md:block">
                                        <span className="text-sm text-luxury-charcoal/60 w-20 md:hidden">Quantity:</span>
                                ...
                                <div className="col-span-2 text-right">
                                    <div className="flex items-center md:block">
                                        <span className="text-sm text-luxury-charcoal/60 w-20 md:hidden">Total:</span>
                    ...
                    <div className="mt-6 flex justify-between items-center">
                        ...
                        <Link href="/products" className="text-luxury-charcoal/70 text-sm hover:text-luxury-sienna transition-colors duration-300 focus-visible">
                            Continue Shopping
                        </Link>
                    </div>
                </div>
