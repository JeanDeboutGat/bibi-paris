...
export default function Footer() {
    return (
        <footer className="bg-white py-16 border-t border-luxury-gold/10">
            <div className="container mx-auto px-4 md:px-8">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 md:gap-8">
                    ...
                    {/* Collections */}
                    <div className="col-span-1">
                        <h3 className="text-sm font-medium uppercase tracking-wider mb-6">Collections</h3>
                    ...
                    {/* About */}
                    <div className="col-span-1">
                        <h3 className="text-sm font-medium uppercase tracking-wider mb-6">About</h3>
                        <ul className="space-y-3">
                            {[
                    ...
                    {/* Customer Service */}
                    <div className="col-span-1">
                        <h3 className="text-sm font-medium uppercase tracking-wider mb-6">Client Services</h3>
                        <ul className="space-y-3">
                            {[
                ...
                <div className="mt-16 pt-8 border-t border-luxury-gold/10">
                    <div className="max-w-xl mx-auto text-center mb-8">
                        <h3 className="text-sm font-medium uppercase tracking-wider mb-4">Subscribe to Our Newsletter</h3>
                        <p className="text-sm text-luxury-charcoal/70 mb-6">
                            Stay informed about new collections, exclusive events, and the world of Bibi Paris.
                        </p>
                ...
                {/* Copyright */}
                <div className="mt-12 pt-8 border-t border-luxury-gold/10 text-center">
