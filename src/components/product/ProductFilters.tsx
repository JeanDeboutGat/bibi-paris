  ...
  return (
    <div className="mb-12">
      ...
      >
        ...
        <span className={`transform transition-transform duration-300 group-hover:text-luxury-gold ${isFilterOpen ? "rotate-180" : ""}`}>
      ...
      >
        ...
        <div>
          <h3 className="font-serif text-lg mb-6 pb-2 border-b border-luxury-gold/10">Category</h3>
          <div className="space-y-4">
            <div className="group">
              <label className="flex items-center cursor-pointer">
                <span className={`w-4 h-4 border ${!selectedCategory ? 'bg-luxury-gold/10 border-luxury-gold' : 'border-luxury-charcoal/20'} mr-3 transition-colors`}></span>
                <input
                  type="radio"
                  name="category"
                  ...
                  className="sr-only"
                />
                <span className={`text-sm ${!selectedCategory ? 'text-luxury-charcoal' : 'text-luxury-charcoal/60'}`}>
                  All Categories
                </span>
              </label>
            </div>
            ...
            {categories.map((category) => (
              <div key={category.value} className="group">
                <label className="flex items-center cursor-pointer">
                  <span className={`w-4 h-4 border ${selectedCategory === category.value ? 'bg-luxury-gold/10 border-luxury-gold' : 'border-luxury-charcoal/20'} mr-3 transition-colors`}></span>
                  <input
                    type="radio"
                    name="category"
                    ...
                    className="sr-only"
                  />
                  <span className={`text-sm ${selectedCategory === category.value ? 'text-luxury-charcoal' : 'text-luxury-charcoal/60'}`}>
                    {category.label}
                  </span>
                </label>
              </div>
        ...
        <div>
          <h3 className="font-serif text-lg mb-6 pb-2 border-b border-luxury-gold/10">Sort By</h3>
          <div className="space-y-4">
            <div className="group">
              <label className="flex items-center cursor-pointer">
                <span className={`w-4 h-4 border ${!selectedSort ? 'bg-luxury-gold/10 border-luxury-gold' : 'border-luxury-charcoal/20'} mr-3 transition-colors`}></span>
                <input
                  type="radio"
                  name="sort"
                  ...
                  className="sr-only"
                />
                <span className={`text-sm ${!selectedSort ? 'text-luxury-charcoal' : 'text-luxury-charcoal/60'}`}>
                  Recommended
                </span>
              </label>
            </div>
            ...
            {sortOptions.map((option) => (
              <div key={option.value} className="group">
                <label className="flex items-center cursor-pointer">
                  <span className={`w-4 h-4 border ${selectedSort === option.value ? 'bg-luxury-gold/10 border-luxury-gold' : 'border-luxury-charcoal/20'} mr-3 transition-colors`}></span>
                  <input
                    type="radio"
                    name="sort"
                    ...
                    className="sr-only"
                  />
                  <span className={`text-sm ${selectedSort === option.value ? 'text-luxury-charcoal' : 'text-luxury-charcoal/60'}`}>
                    {option.label}
                  </span>
                </label>
              </div>
