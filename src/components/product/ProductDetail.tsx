    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="sticky top-32">
                ...
                <p className="text-luxury-gold text-lg mb-8">${product.price.toLocaleString()}</p>
                ...
                <div className="border-t border-luxury-gold/10 mt-10">
                    ...
                    <details className="group py-4 border-b border-luxury-gold/10">
                        ...
                        <div className="pt-4 pb-2 text-luxury-charcoal/70 text-sm leading-relaxed">
                            <p>
                                Made with sustainable wood from responsibly managed forests. Each piece is unique 
                                with slight variations in grain and color that add to its individual character.
                            </p>
                        </div>
                    </details>
                    ...
                    <details className="group py-4 border-b border-luxury-gold/10">
                        ...
                        <div className="pt-4 pb-2 text-luxury-charcoal/70 text-sm leading-relaxed">
                            <p className="mb-2">
                                Free shipping on all orders over $500. For special or oversized items, our white-glove 
                                delivery service ensures your piece arrives safely.
                            </p>
                            <p>
                                Returns accepted within 14 days of delivery. Please note that custom or made-to-order 
                    ...
                    <details className="group py-4 border-b border-luxury-gold/10">
                        ...
                        <div className="pt-4 pb-2 text-luxury-charcoal/70 text-sm leading-relaxed">
                            <p>
                                To maintain the beauty of your wooden furniture, dust regularly with a soft cloth and 
                                avoid direct sunlight. For cleaning, use a damp cloth and mild soap, then dry immediately. 
                                Apply a quality wood wax twice yearly to preserve the finish.
                            </p>
                        </div>
                    </details>
                </div>
